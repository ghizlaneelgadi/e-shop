...
class _LoginState extends State<Login>
{
  ...
  void loginUser() async
  {
    showDialog(
        ...
        builder: (c)
        {
          return LoadingAlertDialog(message: "Authentifucation, Please wait...",);
        }
    );
  ...
  Future readData(FirebaseUser fUser) async
  {
    Firestore.instance.collection("users").document(fUser.uid).get().then((dataSnapshot) async {
      ...
      List<String> carteList= dataSnapshot.data[EcommerceApp.userCartList].cast<String>();
      await EcommerceApp.sharedPreferences.setStringList(EcommerceApp.userCartList, carteList);
    });
  }
}
