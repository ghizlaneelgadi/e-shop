...
import 'package:e_shop/Store/storehome.dart' as prefix0;
...
class _RegisterState extends State<Register>
{
    ...
    if (_imageFile == null)
    ...
    else
      {
        _passwordTextEditingController.text==_cPasswordTextEditingController.text
            ...
            : displayDialog("Please fill up the regestration complete form..")

            : displayDialog("Password de not match.");
      }
  }
  ...
  uploadToStorage()async
  {
    showDialog(
        ...
        builder: (c)
        {
          return LoadingAlertDialog(message: "'Registring, Please wait.....'",);
        }
    );
